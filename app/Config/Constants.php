...
define('SITE_NAME', 'FRB Invitation'); ///NAMA WEBSITE

// =========== production mode ============
// //LINK DOMAIN WITH URL
 define('SITE_UTAMA', 'https://invitation.frbtech.id/'); 
 define('SITE_UNDANGAN', 'https://u.invitation.frbtech.id');
 define('SITE_ADMIN', 'https://admin.invitation.frbtech.id');

// //DOMAIN ONLY
 define('DOMAIN_UTAMA', 'invitation.frbtech.id');
 define('DOMAIN_UTAMA_WWW', 'www.invitation.frbtech.id'); //PAKE WWW
 define('DOMAIN_UNDANGAN', 'u.invitation.frbtech.id');
 define('DOMAIN_ADMIN', 'admin.invitation.frbtech.id');
